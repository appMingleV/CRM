...
const LeadStatusForm = ({ onClose }) => {
  ...
  return (
    <>
      <div className="fixed top-0 h-[700px] w-[1150px] mt-2 border bg-[#FFFFFF80] border-black mx-auto scrollbar-none overflow-y-auto border">
        <div className="relative max-w-xl mx-auto my-2 p-4 bg-white rounded-lg shadow-md border px-8 ">
          <button
            onClick={onClose}
          ...
          <div className="flex items-center justify-between">
            <div className="relative w-1/2 flex gap-2 items-center">
              <label className="text-sm font-medium text-gray-500">
                Leads Status
              </label>
              <select
